...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep  4 14:46:11 2018
...
class Graph(object):
    ...
    def get_edge_list(self):
        ...
        for edge in self.edges:
            edgeDes=(edge.value,edge.node_from,edge.node_to)
            edgesList.append(edgeDes)
        return edgesList
    ...
    def get_adjacency_matrix(self):
        ...
        max_index=self.find_max_index()
        adj_mat=[[0 for i in range(max_index+1)] for j in range(max_index+1)]
        for edge in self.edges:
