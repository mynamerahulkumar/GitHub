...
public class AuthenticationService implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if(user!=null){
            ...
            String hashedPassword=hashService.getHashValue(password,encodeSalt);
    ...
    @Override
    public boolean supports(Class<?> authenitcation) {
        return authenitcation.equals(UsernamePasswordAuthenticationToken.class);
    }
}
